...
export default function Portfolio() {
    const projects = [
        ...
        { img: require('../../assets/images/project-4.png'), title: 'Brawlhalla', category: ' Application' },
        { img: require('../../assets/images/project-5.png'), title: 'DSM', category: ' Web design' },
        { img: require('../../assets/images/project-6.png'), title: 'MetaSprk', category: ' Web design' },
        { img: require('../../assets/images/project-7.png'), title: 'summary', category: ' Web development' },
        { img: require('../../assets/images/project-8.jpg'), title: 'Task manger', category: ' Application' },
